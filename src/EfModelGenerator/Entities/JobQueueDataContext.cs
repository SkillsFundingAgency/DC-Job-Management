...
namespace ESFA.DC.JobQueueManager.Data.Entities
{
    public partial class JobQueueDataContext : DbContext
    {
        ...
        public virtual DbSet<ServiceMessage1> ServiceMessage1 { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=DCT-DG-DEV;Database=JobManagement;Integrated Security=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.Ukprn)
                    .HasName("PK__CovidRel__50F26B71F5182CBD");
            ...
            modelBuilder.Entity<Mcadetail>(entity =>
            {
                ...
                entity.HasIndex(e => e.Ukprn)
                    .HasName("UQ__MCADetai__9242AEE3F42D8C63")
                    .IsUnique();
            ...
            modelBuilder.Entity<ServiceMessage1>(entity =>
            {
