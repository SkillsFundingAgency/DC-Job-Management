...
{
    public class FCSTeamHandOverPart2Email : AbstractEmailTask, IFCSHandOverPart2PathItem
    {
        private readonly ILogger _logger;

        public FCSTeamHandOverPart2Email(
        ...
        public override string DisplayName => "FCS Team Hand Over Part 2 Email";

        public string ReportFileName => null;

        public override int PathItemId => PeriodEndPathItem.FCSTeamHandoverPart2Email;

        public string CollectionNameInDatabase => null;

        public override int EmailPathItemId => EmailIds.FCSTeamHandoverPart2Email;
