...
namespace ESFA.DC.PeriodEnd.Services.ILR.Strategies.DASStartedPath
{
    public class DASStartedEmail : AbstractEmailTask, IDASStartedPathItem
    {
        private readonly ILogger _logger;

        public DASStartedEmail(
        ...
        public override string DisplayName => "DAS Started Email";

        public string ReportFileName => null;

        public override int PathItemId => PeriodEndPathItem.PeriodEndStartedComm;

        public string CollectionNameInDatabase => null;

        public override int EmailPathItemId => EmailIds.DASStartedEmail;

        protected override int PathId => Convert.ToInt32(PeriodEndPath.DASStartedPath);
