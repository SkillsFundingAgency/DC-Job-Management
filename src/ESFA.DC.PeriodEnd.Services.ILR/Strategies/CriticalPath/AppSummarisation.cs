...
{
    public class AppSummarisation : AbstractBlockingPathItem
    {
        public AppSummarisation(
            ILogger logger,
        ...
        public override string DisplayName => "Period End App Summarisation";

        public override List<int> ItemSubPaths => null;

        public override int PathItemId => PeriodEndPathItem.AppSummarisation;
