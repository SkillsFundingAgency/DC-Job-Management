...
{
    public class ActCountReport : AbstractBlockingPathItem
    {
        ...
        public override string DisplayName => "ACT Count Report";

        public override string ReportFileName => "ACT Count Report";

        public override List<int> ItemSubPaths => null;

        public override int PathItemId => PeriodEndPathItem.ActCountReport;

        protected override int PathId => Convert.ToInt32(PeriodEndPath.ILRCriticalPath);

        protected override string CollectionName => PeriodEndConstants.CollectionName_ActCountReport;
