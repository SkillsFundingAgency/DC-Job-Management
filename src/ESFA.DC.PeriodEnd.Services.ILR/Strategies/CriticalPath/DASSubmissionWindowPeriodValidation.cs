...
{
    public class DASSubmissionWindowPeriodValidation : AbstractBlockingPathItem
    {
        public DASSubmissionWindowPeriodValidation(
            ILogger logger,
        ...
        public override string DisplayName => "DAS Submission Window Period Validation";

        public override List<int> ItemSubPaths => null;

        public override int PathItemId => PeriodEndPathItem.DASSubmissionWindowPeriodValidation;

        protected override int PathId => Convert.ToInt32(PeriodEndPath.ILRCriticalPath);

        protected override string CollectionName => PeriodEndConstants.CollectionName_DasSubmissionWindowPeriodValidation;
