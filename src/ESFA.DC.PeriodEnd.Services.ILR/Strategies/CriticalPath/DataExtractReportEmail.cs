...
{
    public class DataExtractReportEmail : AbstractBlockingEmailTask, IILRPathItem
    {
        private readonly ILogger _logger;

        public DataExtractReportEmail(
        ...
        public override string DisplayName => "Period End Data Extract Report Email";

        public string ReportFileName => null;

        public override int PathItemId => PeriodEndPathItem.DataExtractReportEmail;

        public string CollectionNameInDatabase => null;

        public override int EmailPathItemId => EmailIds.DataExtractReportEmail;

        public override int ParentPathItemId => PeriodEndPathItem.DataExtractReport;
