CREATE TABLE [dbo].[CollectionType] (
	...
	[ConcurrentExecutionCount] INT NOT NULL DEFAULT 25, 
    [IsProviderAssignableInOperations] BIT NOT NULL DEFAULT 0, 
	[IsManageableInOperations] BIT NOT NULL DEFAULT 0, 
