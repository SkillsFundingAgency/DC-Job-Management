CREATE TABLE [dbo].[JobSubscriptionTask] (
    [JobTopicTaskId]         INT            NOT NULL IDENTITY,
    [JobTopicId] INT            NOT NULL,
    [TaskName]   NVARCHAR (500) NOT NULL,
    [TaskOrder]  SMALLINT       CONSTRAINT [DF_JobSubscriptionTask_TaskOrder] DEFAULT 1 NOT NULL,
    [Enabled]    BIT            CONSTRAINT [DF_JobSubscriptionTask_Enabled] DEFAULT 1 NOT NULL,
